...
export const STATIONS: Station[] = [
  { id: 'sta-001', name: 'Tasco @ Toyota Savico Long An', address: '1008 Nguyễn Văn Linh, Q.7', lat: 10.7321, lng: 106.7024, slots: 4, queue: 2, inProgress: 2, avgMins: 8, services: ['basic', 'premium', 'detailing', 'ev'], rating: 4.8, reviewCount: 127, priceMin: 50_000, priceMax: 300_000, hasLounge: true, hasWifi: true, open24h: false, evCertified: true, mitsuiCert: true, chemStock: 72, openHours: '07:00 – 21:00' },
  { id: 'sta-002', name: 'Tasco @ Honda Ô Tô Bình Thạnh', address: '176 Bạch Đằng, Q. Bình Thạnh', lat: 10.8103, lng: 106.7143, slots: 3, queue: 5, inProgress: 3, avgMins: 10, services: ['basic', 'premium'], rating: 4.5, reviewCount: 89, priceMin: 50_000, priceMax: 200_000, hasLounge: false, hasWifi: true, open24h: false, evCertified: false, mitsuiCert: true, chemStock: 45, openHours: '07:00 – 21:00' },
  { id: 'sta-003', name: 'Tasco @ VinFast Gò Vấp', address: '32 Quang Trung, Q. Gò Vấp', lat: 10.8490, lng: 106.6737, slots: 5, queue: 1, inProgress: 2, avgMins: 9, services: ['basic', 'premium', 'detailing', 'ev'], rating: 4.9, reviewCount: 214, priceMin: 50_000, priceMax: 350_000, hasLounge: true, hasWifi: true, open24h: true, evCertified: true, mitsuiCert: false, chemStock: 88, openHours: '24/7' },
  { id: 'sta-004', name: 'Tasco @ Hyundai Thủ Đức', address: '63 Võ Văn Ngân, TP. Thủ Đức', lat: 10.8511, lng: 106.7609, slots: 4, queue: 0, inProgress: 1, avgMins: 7, services: ['basic', 'premium', 'ev'], rating: 4.6, reviewCount: 56, priceMin: 50_000, priceMax: 220_000, hasLounge: true, hasWifi: false, open24h: false, evCertified: true, mitsuiCert: true, chemStock: 91, openHours: '06:30 – 22:00' },
  { id: 'sta-005', name: 'Tasco Detailing Centre — Q.1', address: '28 Lê Thánh Tôn, Q.1', lat: 10.7773, lng: 106.7028, slots: 2, queue: 3, inProgress: 2, avgMins: 25, services: ['premium', 'detailing'], rating: 4.9, reviewCount: 302, priceMin: 200_000, priceMax: 800_000, hasLounge: true, hasWifi: true, open24h: false, evCertified: false, mitsuiCert: true, chemStock: 60, openHours: '08:00 – 20:00' },
  { id: 'sta-006', name: 'Tasco @ Kia Tân Bình', address: '514 Cộng Hòa, Q. Tân Bình', lat: 10.8024, lng: 106.6561, slots: 3, queue: 4, inProgress: 3, avgMins: 8, services: ['basic', 'premium'], rating: 4.3, reviewCount: 41, priceMin: 50_000, priceMax: 180_000, hasLounge: false, hasWifi: false, open24h: false, evCertified: false, mitsuiCert: false, chemStock: 23, openHours: '07:00 – 20:00' },
